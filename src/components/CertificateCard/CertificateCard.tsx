...
const CertificateCard: React.FC<CertificateCardViewProps> = ({ certificate }) => {
  ...
  return (
    <li className="flex flex-col sm:flex-row gap-4 items-start pb-8 mb-6 last:border-b-0 last:pb-0 last:mb-0">
      ...
      <div className="">
        ...
        {skills && (
          <p className="mt-3 text-lg text-neutral-300 flex gap-2">
            <FaCodeBranch />
            <strong className="text-neutral-200">Competências:</strong> {skills}
          </p>
        )}
      </div>
    </li>
